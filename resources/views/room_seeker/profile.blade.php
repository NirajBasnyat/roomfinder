                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if(empty($seeker))
                                <div class="modal fade " id="addProfile{{$user->id}}" data-backdrop="static"
                                     tabindex="-1"
                                    ...
                                    <form action="{{route('seeker.store')}}" method="post"
                                        ...
                                        @else
                                            <div class="modal fade" id="updateProfile{{$user->id}}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12 col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend">
                                                                                <span
                                                                                    class="input-group-text">Email</span>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12 col-md-6">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend">
                                                                                <span class="input-group-text">Social Media Links</span>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-12 col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend">
                                                                                <span
                                                                                    class="input-group-text">Avatar</span>
                                                                            </div>
